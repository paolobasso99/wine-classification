...
```{r}
load(file="chains/binomial_model_scaled_lasso_alpha01.dat")
```
...
load(file="chains/binomial_model_scaled_lasso_thin50_alpha001.dat")
alpha001 = output
load(file="chains/binomial_model_scaled_lasso_thin_alpha01.dat")
alpha01 = output
load(file="chains/binomial_model_scaled_lasso_thin50_alpha05.dat")
alpha05 = output
...
```{r}
load(file="chains/binomial_model_scaled_lasso_thin50_shrinked_ultra.dat")
lasso_s = output
load(file="chains/binomial_model_scaled_lasso_thin50.dat")
lasso = output
p <- ggplot_compare_all_d(lasso_s, lasso, 11)
p
ggsave("pictures/binomial/binomial_comparison_lasso_n_vs_ultra.png", plot=p)
inv_lambda <-ggplot_compare_densities(lasso_s, lasso, "lambda")
inv_lambda
ggsave("pictures/binomial/binomial_comparison_lasso_LAMBDA_n_vs_ultra.png", plot=inv_lambda)
```
