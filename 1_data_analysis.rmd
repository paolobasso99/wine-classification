...
wine
```
All the columns are continuous, a part from the quality one.
Free sulfur dioxide and Total sulfur dioxide are continuous covariates even thought by the values it seems they are discrete. 
